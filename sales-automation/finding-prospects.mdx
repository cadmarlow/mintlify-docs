...
Discover qualified leads in seconds using natural language search powered by Firecrawl AI.
...
```mermaid
graph LR
    A[Enter Search Query] --> B[Firecrawl Scrapes Web]
...
<CardGroup cols={2}>
  ...
  <Card title="Best Practices" icon="lightbulb" href="/guides/best-practices">
    Learn tips for better prospecting
  </Card>
</CardGroup>
